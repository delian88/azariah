...
const Services: React.FC<ServicesProps> = ({ onExploreMore }) => {
  return (
    <div id="what-we-do">
      <SectionWrapper bg="light">
        <div className="space-y-16">
          <div className="max-w-3xl space-y-6">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-slate-900 tracking-tight uppercase text-shine">What We Do</h2>
            ...
            <button 
              ...
              className="group flex items-center gap-2 text-xs font-black uppercase tracking-widest text-slate-900 hover:text-blue-700 transition-colors"
            >
              Explore Our Full Service Suite <LucideIcons.ArrowRight className="w-4 h-4 group-hover:translate-x-2 transition-transform" />
            </button>
          </div>
            ...
            {WHAT_WE_DO.map((service) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl font-black text-slate-900 mb-4 tracking-tighter">{service.title}</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-20">
          <div className="space-y-10">
            <div className="space-y-4">
              <h2 className="text-3xl font-black uppercase tracking-tighter text-shine-white">How We Work</h2>
          ...
          <div className="space-y-10">
            <div className="space-y-4">
              <h2 className="text-3xl font-black uppercase tracking-tighter text-shine-white">Our Divisions</h2>
            ...
            <div className="grid gap-4">
              {DIVISIONS.map(div => (
                <div key={div} className="p-6 bg-slate-800/50 border border-slate-700 rounded-sm hover:border-slate-500 transition-all flex items-center justify-between group">
                  ...
                  <LucideIcons.ArrowRight className="w-5 h-5 text-slate-600 group-hover:text-lime-500 transition-all transform group-hover:translate-x-2" />
                </div>
              ))}
            </div>
          </div>
